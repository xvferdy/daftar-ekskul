<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    // cek apakah username dan password ada di tabel pakguru
    $query = "SELECT * FROM pakguru WHERE username = '$username' 
    ...
    if ($pesan_error === "") {
      ...
      header("Location: ekstra_kurikuler.php");
    }
  }
  else {
