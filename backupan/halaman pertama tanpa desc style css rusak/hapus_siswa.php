...
?>
 <table border="1">
  ...
  <?php
  // buat query untuk menampilkan seluruh data tabel extrakurikuler
  ...
  //buat perulangan untuk element tabel dari data extrakurikuler
  while($data = mysqli_fetch_assoc($result))
  {
    ...
    echo "<td>$data[extrakurikuler]</td>";
    echo "<td>";
    ?>
