<?php
  ...
  if(!$hasil_query){
   ...
   // cek apakah tabel ekstrakurikuler sudah ada. jika ada, hapus tabel
  $query = "DROP TABLE IF EXISTS ekstrakurikuler";
  $hasil_query = mysqli_query($link, $query);
  ...
  if(!$hasil_query){
    ...
    echo "Tabel <b>'ekstrakurikuler'</b> berhasil dihapus... <br>";
  }
  
  // buat query untuk CREATE tabel ekstrakurikuler

  $query  = "CREATE TABLE ekstrakurikuler (kode VARCHAR(8), ekstrakurikuler VARCHAR(100)) "; 
  ...
  if(!$hasil_query){
    ...
    echo "Tabel <b>'ekstrakurikuler'</b> berhasil dibuat... <br>";
  }
  
  // buat query untuk INSERT data ke tabel ekstrakurikuler
  $query  = "INSERT INTO ekstrakurikuler VALUES "; 
  $query .= "('01','Sepak Bola' ),";
  $query .= "('02','Bulutangkis' ),";
  $query .= "('03','Renang' ),";
  $query .= "('04','Basket' ),";
  $query .= "('05','TataBoga' ),";
  $query .= "('06','Bahasa Asing' ),";
  $query .= "('07','Klub Matematika' ),";
  $query .= "('08','Klub sains' ),";
  $query .= "('09','Komputer' ),";
  $query .= "('0110','Catur') ";
  ...
  if(!$hasil_query){
    ...
    echo "Tabel <b>'ekstrakurikuler'</b> berhasil diisi... <br>";
  }
